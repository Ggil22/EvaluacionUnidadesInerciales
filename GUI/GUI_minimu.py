...
def Run():
    ...
    # Amplia y establece el rango de la ventana.
    scene.range=5
    # Variable que ayuda a transformar un numero de radianes a decimales.
    toDeg=1/toRad
    ...
    while terminate!=True:
        # Obtenemos la linea que devuelve arduino por el puerto serial.
            ...
            roll = float(words[0])*toRad
            pitch = float(words[1])*toRad
            yaw = float(words[2])*toRad+np.pi
